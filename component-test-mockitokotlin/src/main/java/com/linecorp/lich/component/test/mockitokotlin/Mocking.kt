 ...
 */
package com.linecorp.lich.component.test.mockitokotlin
...
): T = mock(stubbing = stubbing).also { setMockComponent(factory, it) }
...
inline fun <reified T : Any> spyComponent(
    factory: ComponentFactory<T>,
    stubbing: KStubbing<T>.(T) -> Unit = {}
): T = spy(value = getRealComponent(factory), stubbing = stubbing)
