 ...
 *
 * The [viewModelArgs] will be the default argument of the ViewModel for the Activity.
 */
 ...
 *
 * The [viewModelArgs] will be the default argument of the ViewModel for the Fragment.
 */
